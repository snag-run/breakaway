...
#
#     PHX_SERVER=true bin/breakaway start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :breakaway, BreakawayWeb.Endpoint, server: true
end
  ...
  config :breakaway, BreakawayWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/breakaway_web/router\.ex$"E,
        ~r"lib/breakaway_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
...
if config_env() == :prod do
  ...
  config :breakaway, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :breakaway, Breakaway.Mailer,
